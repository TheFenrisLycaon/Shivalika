from shivalika.api.collection.activation import ActivationSkills
from shivalika.api.collection.info import AssistantInfoSkills
from shivalika.api.collection.datetime import DatetimeSkills
from shivalika.api.collection.browser import BrowserSkills
from shivalika.api.collection.general import UtilSkills
from shivalika.api.collection.internet import InternetSkills
from shivalika.api.collection.libreoffice import LibreofficeSkills
from shivalika.api.collection.linux import LinuxAppSkills
from shivalika.api.collection.location import LocationSkill
from shivalika.api.collection.reminder import ReminderSkills
from shivalika.api.collection.system_health import SystemHealthSkills
from shivalika.api.collection.weather import WeatherSkills
from shivalika.api.collection.text import WordSkills
from shivalika.api.collection.history import HistorySkills
from shivalika.api.collection.remember import RememberSkills
from shivalika.api.collection.math import MathSkills
from shivalika.utils.mapping import math_tags
from shivalika.api.collection.configuration import ConfigurationSkills
...
skill_objects = {
    skill["func"].__name__: skill["func"] for skill in BASIC_SKILLS + CONTROL_SKILLS
}
