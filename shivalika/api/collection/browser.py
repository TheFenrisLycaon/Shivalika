        ...
        for tag in tags:
            ...
            if reg_ex:
                ...
                try:
                    ...
                    cls.console(
                        error_log="Error with the execution of skill with message {0}".format(
                            e
                        )
                    )
                    cls.response(
                        " I can't find what you want, and I will open a new tab in browser"
                    )
                    time.sleep(1)
