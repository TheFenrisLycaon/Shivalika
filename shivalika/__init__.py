...
from shivalika.settings import ROOT_LOG_CONF
from shivalika.utils.mongoDB import db
from shivalika.utils.startup import configure_MongoDB
from shivalika.enumerations import InputMode
import shivalika.engines as engines
...
# ----------------------------------------------------------------------------------------------------------------------
input_engine = (
    engines.STTEngine() if input_mode == InputMode.VOICE.value else engines.TTTEngine()
)
