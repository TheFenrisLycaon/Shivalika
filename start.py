#!/home/fenris/.condahome/envs/chatbot/bin/python
from shivalika import settings
from shivalika.utils.startup import internet_connectivity_check
from shivalika.core.processor import Processor
